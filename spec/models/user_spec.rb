...
describe User do
  ...
  it "should reject duplicate email address" do
    User.create!(@attr)
    user_with_duplicaet_email = User.new(@attr)
    user_with_duplicaet_email.should_not be_valid
  end
  ...
  describe "password validations" do
    ...
    it "should reject logn passwords " do
      long_password = "a"*33
  ...
  describe "password encryption" do
    ...
    it "should have an encrypted password attrib" do
    ...
    describe "authentificate method" do
      ...
      it "should return nil for an email address with no user" do
        nonexistent_user = User.authenticate("gigi@cor.com", @attr[:password])
